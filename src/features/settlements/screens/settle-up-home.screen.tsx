...
export default function SettleUpHomeScreen() {
    ...
    <CustomFormSheet>
      <View style={styles.container}>
        ...
        {isStep1 && (
          <>
            <InfoBox
              title="Settlements are tied to tabs."
              description="First, select the group you want to settle within. You'll pick the tab next."
            />
        ...
        {!isStep1 && (
          <>
            <InfoBox
              ...
              description="Now select which tab you want to record a settlement for."
            />
            <View style={[styles.optionContainer, { zIndex: 3000 }]}>
            ...
            <CustomButton
              ...
              onPress={() =>
                navigation.dispatch(
                  StackActions.replace('RecordPayment', { poolId: selectedPool!.id }),
                )
              }
